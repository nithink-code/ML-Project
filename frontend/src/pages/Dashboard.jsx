...
import { BrainCircuit, LogOut, Plus, Clock, CheckCircle, Star } from 'lucide-react';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <Card className="mb-12 glass" data-testid="new-interview-card">
          <CardHeader>
            ...
            <CardDescription>Choose an interview type to begin your practice session</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                <div className="text-left">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">Technical</h3>
              ...
              >
                <div className="text-left">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">Behavioral</h3>
                  <p className="text-sm text-gray-600">
              ...
              >
                <div className="text-left">
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">General</h3>
                  <p className="text-sm text-gray-600">
        ...
        <Card className="glass" data-testid="interview-history-card">
          <CardHeader>
            ...
            <CardDescription>View and continue your past interviews</CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
              ...
              <div className="text-center py-12">
                <p className="text-gray-500">No interviews yet. Start your first practice session above!</p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="outline" size="sm">
                        {interview.status === 'evaluated' ? 'View Results' : 'Continue'}
                      </Button>
                    </div>
                  </div>
                ))}
